...
If you're using AI coding CLIs like [Claude Code](https://code.claude.com/docs/en/overview), [Copilot CLI](https://github.com/features/copilot/cli), [OpenCode](https://opencode.ai/), [Codex](https://openai.com/codex/), and [Pi](https://pi.dev/) this article is for you.
...
Inspired from Anthropic's [`effective harnesses for long-running agents`](https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents):
